...
public class HandBlackJackTest {
	...
	public void test1() {
		...
		//  Test 2-3-4, score should be 9

		ArrayList<Card> cards = new ArrayList<Card>();
		
		//   REMOVE THE COMMENTS FROM THE NEXT THREE LINES
		...
		//	 Check Score to make sure it's right.  Something close to this:
	...
	public void test2() {
		...
		//  Test J-A, Scores should be 11 & 21
	...
	public void test3() {
		...
		//  Test J-A-A, Scores should be 12, 22, 32
	...
	public void test4() {
		...
		//  Test J-A-A-A, Scores should be 13, 23, 33, 43
